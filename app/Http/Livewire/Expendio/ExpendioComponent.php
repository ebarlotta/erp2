...
class ExpendioComponent extends Component
{
    ...
    public $cerradoDesayuno, $regs, $borrar;
    ...
    public function render() {
        // if(auth()->check() && auth()->user()->hasPermissionTo('expendio.Ver')) {
            if(session('empresa_id')) {
                ...
                $this->CargarMenues();
// $this->registros_desayuno=null;
// $this->registros_almuerzo=null;
// $this->registros_mediatarde=null;
// $this->registros_cena=null;
    ...
    public function CargarMenues() {
        ...
        $diaDelCiclo = ($diasTranscurridos % 14) + 1;
$this->borrar = $diaDelCiclo;
        ...
        ->where('menu_plans.dia','=',$diaDelCiclo)
        ->get();
                // var_dump($this->registros_desayuno);
